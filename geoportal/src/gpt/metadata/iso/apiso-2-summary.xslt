  ...
  <xsl:template match="/gmi:MI_Metadata">
	...
	<xsl:template match="//gmd:identificationInfo">
		<xsl:copy>
				...
				<xsl:if test="count(//gmd:identificationInfo/srv:SV_ServiceIdentification/gmd:citation/gmd:CI_Citation/gmd:title)=1">
	...
	<xsl:template match="//gmd:identificationInfo/gmd:MD_DataIdentification">
		<xsl:copy>
			...
			<xsl:copy-of select="//gmd:identificationInfo/gmd:MD_DataIdentification/gmd:pointOfContact[gmd:CI_ResponsibleParty/gmd:role/gmd:CI_RoleCode/@codeListValue='originator']"/>			
			<xsl:copy-of select="//gmd:identificationInfo/gmd:MD_DataIdentification/gmd:pointOfContact[gmd:CI_ResponsibleParty/gmd:role/gmd:CI_RoleCode/@codeListValue='author']"/>			
			<xsl:copy-of select="//gmd:identificationInfo/gmd:MD_DataIdentification/gmd:pointOfContact[gmd:CI_ResponsibleParty/gmd:role/gmd:CI_RoleCode/@codeListValue='publisher']"/>			
			
			<xsl:copy-of select="//gmd:identificationInfo/gmd:MD_DataIdentification/gmd:graphicOverview"/>
			<xsl:copy-of select="//gmd:identificationInfo/gmd:MD_DataIdentification/gmd:resourceConstraints[count(gmd:MD_LegalConstraints)>0]"/>
			<xsl:copy-of select="//gmd:identificationInfo/gmd:MD_DataIdentification/gmd:spatialRepresentationType"/>
			<xsl:copy-of select="//gmd:identificationInfo/gmd:MD_DataIdentification/gmd:spatialResolution"/>			
			<xsl:copy-of select="//gmd:identificationInfo/gmd:MD_DataIdentification/gmd:language"/>						
			<xsl:copy-of select="//gmd:identificationInfo/gmd:MD_DataIdentification/gmd:topicCategory"/>							
	...
	<xsl:template match="//gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation">
		<xsl:copy>
			 ...
			 <xsl:copy-of select="//gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:identifier"/> 
			 <xsl:copy-of select="//gmd:identificationInfo/gmd:MD_DataIdentification/gmd:citation/gmd:CI_Citation/gmd:date[gmd:dateType/gmd:CI_DateTypeCode/@codeListValue='revision']"/> 			 
		</xsl:copy>
	</xsl:template>
